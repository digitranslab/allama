...
- `allama/`: Python backend services, Temporal workers, and expression engine utilities.
- `packages/allama-registry/`: Registry package and YAML action templates; templates live under `allama_registry/templates/`.
