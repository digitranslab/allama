"""Benchmark server for load testing the executor API."""
...
app = FastAPI(title="Benchmark Server")
...
async def wait_and_return_data(
    ...
    """Wait for the specified duration and return timing data."""
...
def sync_wait_and_return_data(
    ...
    """Synchronous wait endpoint for comparison."""
    start_time = time.time()
