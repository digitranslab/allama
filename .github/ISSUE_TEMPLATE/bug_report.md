...
**Provide logs**
If applicable, please provide logs from the relevant Allama container (`api`, `worker`, `executor`, `ui`) or browser console (e.g. `Chrome DevTools`).
...
- Where did you deploy Allama? (VM, AWS EC2, etc.)
- CPU architecture
