---
title: Google OAuth
description: Learn how to authenticate into Allama using Google OAuth.
icon: google
---
...
```bash
ALLAMA__AUTH_TYPES=google_oauth
```
...
<Steps>
  <Step title="Set up OAuth consent screen in Google">
    ...
    1. Create a new app.
    2. Set **Authorized JavaScript origins** to the domain you're serving Allama from.
  ...
  <Step title="Configure environment variables in Allama">
