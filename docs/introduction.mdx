---
title: Introduction
description: A quick overview of Allama.
sidebarTitle: What is Allama?
icon: shield-cat
---

[Allama](https://allama.com) is a modern, open source automation platform built for security and IT engineers.
Allama comes with a no-code / low-code UI for workflows, out-of-the-box integrations, lookup tables, and case management.
...
<Tip>
  ...
  This tutorial covers all the core features of Allama, which will save you hours of learning time.
</Tip>

<CardGroup cols={3}>
  <Card title="Install" icon="download" href="/quickstart/install">
    Self-host Allama on your own infrastructure.
  </Card>
  <Card title="Users" icon="user" href="/quickstart/admin">
    Log into Allama and invite your team.
  </Card>
...
<Note>
  You can sync custom YAML integrations and Python scripts directly into Allama from a private Git repo.
  Learn more in the [custom integrations](/tutorials/custom-integrations) tutorial.

  This is the recommended way to use Allama.
...
<CardGroup cols={3}>
  <Card title="Integrations" icon="puzzle-piece" href="/cheatsheets/integrations">
    Out-of-the-box tools and integrations in Allama.
  </Card>
