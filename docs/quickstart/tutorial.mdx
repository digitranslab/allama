---
title: Quickstart
description: Everything you need to know to get started with Allama.
icon: rocket
---
...
- Have Allama [installed](/quickstart/install)
...
<AccordionGroup>
  ...
  <Accordion title="Call an external weather API" icon="cloud-sun">
    ...
    Allama uses YAML to define action inputs.
...
Actions are the building blocks of Allama workflows.
Allama has two main types of actions:
...
Find out more in Allama's [core actions](/integrations/core) and [tools](/integrations/tools) docs.
...
- Learn about Allama's [core actions](/quickstart/core-actions).
...
- Join our [Discord community](https://discord.gg/2mK6h9rp) for ideas and support.
