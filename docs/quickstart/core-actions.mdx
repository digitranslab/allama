---
title: Core actions
description: Building blocks of Allama workflows and action templates.
icon: cube
---
...
<Tip>
  All core actions are open source and available in [Allama's GitHub repository](https://github.com/digitranslab/allama/tree/main/registry/allama_registry/core).
</Tip>
...
Core actions are the building blocks of Allama workflows and action templates.
...
`core` actions are the most commonly used actions in Allama.
They include:
...
<Tip>
  ...
  This action is one of the most commonly used and powerful action in Allama.
...
<Steps>
  <Step title="Create URLScan secret">
    Add URLScan API key to Allama's built-in secrets manager.
