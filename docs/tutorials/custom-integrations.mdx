...
description: Build and sync custom integrations from a private Git repository into Allama.
icon: github
---
...
<Note>
  Git sync is the recommended way to sync custom integrations into Allama in production.

  For local development, you can specify the environment variables:
  - `ALLAMA__LOCAL_REPOSITORY_ENABLED` to `true`
  - `ALLAMA__LOCAL_REPOSITORY_PATH` to the path of the local repository

  This will hot reload changes from your custom integrations repository into Allama.
</Note>
...
- Sync custom integrations into Allama
...
In this section, we'll walk through the process of securely syncing custom integrations into Allama.
...
<Steps>
  ...
  <Step title="Private key in Allama">
  ...
  <Step title="Refresh repos in Allama">
  ...
  <Step title="Sync custom repo">
    ...
    Your custom integrations should now be visible in your Allama instance's registry.
  </Step>
  ...
  <Step title="🎉 That's it!">
    ...
    Just push to your changes to the git repo and press sync in Allama Registry.
...
<Tip>
  ...
  Check out Allama's open source [Action Templates](https://github.com/digitranslab/allama/tree/main/packages/allama-packages/allama-registry/allama_registry/templates) on GitHub for examples.
...
<Tip>
  Check out Allama's open source [core actions](https://github.com/digitranslab/allama/tree/main/packages/allama-registry/allama_registry/core)
  and [Python integrations](https://github.com/digitranslab/allama/tree/main/packages/allama-registry/allama_registry/integrations) on GitHub for examples.
</Tip>
...
- Join our [Discord community](https://discord.gg/n3GF4qxFU8) and meet other Allama users and contributors.
- Have integrations you'd like to share with the community? Open up an [issue](https://github.com/digitranslab/allama/issues) on GitHub and start contributing to open source!
