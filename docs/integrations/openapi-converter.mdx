...
description: Convert OpenAPI specs to Allama Action Templates.
icon: file-import
---

Allama has a tool that converts OpenAPI 3.0 specifications into [action templates](/integrations/action-templates). This utility allows you to quickly generate HTTP actions for any API that has an OpenAPI (formerly Swagger) specification, making integration with external services easier and more consistent.
...
<Note>
  ...
  specifications, please reach out to the Allama support team via our [Discord
  channel](https://discord.gg/2mK6h9rp).
</Note>
...
3. The Allama package installed
...
definition_overrides:
  ...
  display_group: "PetStore" # Group name in the Allama UI
