...
from allama.dsl.schemas import ActionRetryPolicy, ActionStatement, RunActionInput
from allama.dsl.worker import get_activities
...
async def test_workflow_wait_until_future(
    ...
    # Use standard queues: DSL worker on TEMPORAL__CLUSTER_QUEUE, executor mock on ALLAMA__EXECUTOR_QUEUE
    async with (
