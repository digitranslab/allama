...
from allama_registry.core import grpc as grpc_core
from allama_registry.core.grpc import request as grpc_request
...
def _create_ca() -> tuple[rsa.RSAPrivateKey, x509.Certificate]:
    ...
    subject = issuer = x509.Name(
        [x509.NameAttribute(NameOID.COMMON_NAME, "allama-test-ca")]
    )
    cert = (
