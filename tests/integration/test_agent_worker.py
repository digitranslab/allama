...
from allama_ee.agent.workflows.durable import AgentWorkflowArgs, DurableAgentWorkflow
...
from allama.agent.types import AgentConfig, StreamKey
...
from allama.redis.client import get_redis_client
...
class TestAgentWorkerLifecycle:
    ...
    async def test_worker_module_has_expected_structure(self) -> None:
        ...
        from allama.agent import worker
    ...
    async def test_mcp_modules_have_expected_structure(self) -> None:
        ...
        from allama.agent.mcp import proxy_server, trusted_server
