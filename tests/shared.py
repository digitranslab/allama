...
from allama.identifiers.action import ref
from allama.identifiers.workflow import EXEC_ID_PREFIX, WorkflowUUID
...
def user_client() -> httpx.AsyncClient:
    ...
    return httpx.AsyncClient(
        ...
        base_url=os.environ.get("ALLAMA__PUBLIC_API_URL", "http://localhost:8000"),
    )
