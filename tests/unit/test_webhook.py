...
from allama.webhooks.dependencies import _ip_allowed, parse_webhook_payload
from allama.webhooks.schemas import WebhookApiKeyRead, _normalize_cidrs
...
class TestWebhookSecret:
    ...
    def test_secret_uses_legacy_prefixed_format(self):
        ...
        with patch.dict("os.environ", {"ALLAMA__SIGNING_SECRET": signing_secret}):
