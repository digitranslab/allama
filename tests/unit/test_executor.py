...
from allama_registry import RegistryOAuthSecret, SecretNotFoundError

from allama.auth.types import Role
from allama.db.models import RegistryVersion
from allama.dsl.common import create_default_execution_context
from allama.dsl.schemas import ActionStatement, RunActionInput, RunContext
from allama.exceptions import ExecutionError, LoopExecutionError
from allama.executor.backends.direct import DirectBackend
from allama.executor.schemas import ActionImplementation, ExecutorActionErrorInfo
...
from allama.integrations.enums import OAuthGrantType
from allama.integrations.schemas import ProviderKey
from allama.integrations.service import IntegrationService
...
from allama.registry.versions.schemas import RegistryVersionManifestAction
from allama.registry.versions.service import RegistryVersionsService
...
async def create_manifest_for_actions(
    ...
    from allama.db.models import RegistryRepository
...
def make_registry_lock(action: str, origin: str = "allama_registry") -> RegistryLock:
...
async def test_direct_backend_execute(
    ...
    from allama.executor.backends.direct import DirectBackend
    from allama.executor.schemas import ExecutorResultSuccess, ResolvedContext
...
async def test_direct_backend_returns_wrapped_error(
    ...
    from allama.executor.backends.direct import DirectBackend
    from allama.executor.schemas import ExecutorResultFailure, ResolvedContext
