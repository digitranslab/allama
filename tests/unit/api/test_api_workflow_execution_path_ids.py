...
from allama.workflow.executions import internal_router as internal_executions_router
from allama.workflow.executions import router as executions_router
...
async def test_get_workflow_execution_compact_accepts_slash_id(
    ...
    mock_execution.task_queue = "allama-task-queue"
