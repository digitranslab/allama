...
from allama_ee.admin.settings import router as settings_router
from allama_ee.admin.settings.schemas import PlatformRegistrySettingsRead
...
async def test_get_registry_settings_success(
    ...
    settings = PlatformRegistrySettingsRead(
        ...
        git_repo_package_name="allama_registry",
