...
async def test_get_table_not_found(
    ...
    with patch.object(tables_router, "TablesService") as MockService:
        mock_svc = AsyncMock()
        mock_svc.get_table.side_effect = AllamaNotFoundError("Table not found")
        MockService.return_value = mock_svc
