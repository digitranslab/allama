...
from allama.db.models import Action, Schedule, Tag, Webhook, Workflow, Workspace
from allama.pagination import CursorPaginatedResponse
from allama.workflow.management import router as workflow_management_router
...
async def test_list_workflows_with_pagination(
    ...
    with (
        patch(
            "allama.workflow.management.router.WorkflowsManagementService"
        ) as MockService,
    ):
        mock_svc = AsyncMock()
        mock_response = CursorPaginatedResponse(
