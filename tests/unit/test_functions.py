...
from allama.expressions.functions import (
    _bool,
    add,
    add_prefix,
    add_suffix,
...
@pytest.mark.parametrize(
    "input_str,expected",
    [
        ("admin+allama1@gmail.com", "admin%2Ballama1%40gmail.com"),
        ("admin+allama1-org@gmail.com", "admin%2Ballama1-org%40gmail.com"),
    ],
)
...
@pytest.mark.parametrize(
    "input_str,expected",
    [
        ("admin%2Ballama1%40gmail.com", "admin+allama1@gmail.com"),
        ("admin%2Ballama1-org%40gmail.com", "admin+allama1-org@gmail.com"),
    ],
)
