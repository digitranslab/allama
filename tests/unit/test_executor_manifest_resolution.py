...
from allama.db.models import RegistryAction, RegistryRepository, RegistryVersion
...
from allama.executor.service import _prepare_step_context, prepare_resolved_context
from allama.identifiers.workflow import WorkflowUUID, generate_exec_id
...
async def test_prepare_resolved_context_uses_manifest_for_locked_workflows(
    ...
    mocker.patch(
        "allama.executor.service.secrets_manager.get_action_secrets",
        return_value={},
    )
    mocker.patch("allama.executor.service.get_workspace_variables", return_value={})
    ...
    mocker.patch(
        "allama.executor.service.get_async_session_context_manager", _session_cm
    )
    mocker.patch(
        "allama.executor.registry_resolver.get_async_session_context_manager",
        _session_cm,
    )
