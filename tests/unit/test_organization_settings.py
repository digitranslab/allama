...
from allama.settings.router import check_other_auth_enabled
...
from allama.settings.service import SettingsService, get_setting, get_setting_override
...
def test_get_setting_override(
    ...
    if expected is not None:
        monkeypatch.setenv(f"ALLAMA__SETTING_OVERRIDE_{key.upper()}", env_value)
