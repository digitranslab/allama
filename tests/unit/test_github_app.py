...
from allama.secrets.schemas import SecretKeyValue
...
class TestGitHubAppService:
    ...
    async def test_register_app_success(self, github_admin_service, mock_credentials):
        ...
        with patch("allama.vcs.github.app.SecretsService") as mock_secrets_service:
    ...
    async def test_get_github_app_credentials_status_exists(
        ...
        with patch.object(
            ...
            with patch(
                "allama.vcs.github.app.SecretsService"
    ...
    async def test_get_github_client_for_repo_success(
        ...
        with (
            ...
            patch("allama.vcs.github.app.GithubIntegration") as mock_gh_integration,
            patch("allama.vcs.github.app.asyncio.to_thread") as mock_to_thread,
        ):
