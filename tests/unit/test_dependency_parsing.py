...
class TestDependencyModels:
    ...
    def test_parse_real_world_complex_conflict(self):
        ...
        error_message = """
        Failed to install repository: Updating ssh://git@github.com/digitranslab/internal-registry.git (0c6d4e00cba5f309e208dee11994f3ddbeb1bc42)
        Updated ssh://git@github.com/digitranslab/internal-registry.git (0c6d4e00cba5f309e208dee11994f3ddbeb1bc42)
        ...
        ╰─▶ Because only custom-actions==0.1.0 is available and
            ...
            And because allama depends on custom-actions, we can conclude that
            allama depends on pydantic==1.10.22.
            And because allama depends on pydantic==2.10.6 and your workspace
            requires allama, we can conclude that your workspace's requirements
            are unsatisfiable.
