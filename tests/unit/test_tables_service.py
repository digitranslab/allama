...
class TestTablesService:
    ...
    async def test_delete_table(self, tables_service: TablesService) -> None:
        ...
        # Attempt to retrieve the table; should raise AllamaNotFoundError
        with pytest.raises(AllamaNotFoundError):
...
class TestTableColumns:
    ...
    async def test_delete_column(self, tables_service: TablesService) -> None:
        ...
        # Attempt to retrieve the deleted column; should raise AllamaNotFoundError
        with pytest.raises(AllamaNotFoundError):
...
class TestTableRows:
    ...
    async def test_delete_row(
        ...
        # Attempt to retrieve the deleted row; should raise AllamaNotFoundError
        with pytest.raises(AllamaNotFoundError):
