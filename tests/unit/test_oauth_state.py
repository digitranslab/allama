...
from allama.db.models import OAuthStateDB, User, Workspace
from allama.integrations.enums import OAuthGrantType
from allama.integrations.providers.base import AuthorizationCodeOAuthProvider
...
def register_mock_provider():
    ...
    with patch("allama.integrations.service.get_provider_class") as mock_get_provider:
