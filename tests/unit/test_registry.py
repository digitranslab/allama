...
from allama.exceptions import RegistryValidationError
from allama.git.utils import GitUrl, parse_git_url
...
@pytest.mark.parametrize(
    ...
    [
        ...
        # Private GitLab
        (
            "git+ssh://git@internal.allama/org/repo",
            GitUrl(
                host="internal.allama",
                org="org",
                repo="repo",
                ref=None,
            ),
        ...
        # (
        #     "git+ssh://git@internal.allama/org/group/repo",
        #     GitUrl(
        #         host="internal.allama",
        #         org="org/group",
        #         repo="repo",
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            "git+ssh://git@allama.com/allama-dev/allama-registry.git@v1.0.0",
            id="Invalid host domain allama.com",
        ),
        pytest.param(
            "git+ssh://git@git.com/allama-dev/allama-registry.git@v1.0.0",
...
def test_iter_valid_files(tmp_path):
    ...
    from allama.registry.repository import iter_valid_files
