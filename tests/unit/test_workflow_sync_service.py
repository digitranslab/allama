...
class TestWorkflowSyncService:
    ...
    async def test_push_workflows_success(
        ...
        with (
            patch(
                "allama.workflow.store.sync.GitHubAppService"
            ...
            assert result.ref.startswith("allama-sync-")
    ...
    async def test_push_workflows_with_pr(
        ...
        with (
            ...
            patch("asyncio.to_thread") as mock_to_thread,
            patch(
                "allama.workflow.store.sync.WorkspaceService"
...
class TestWorkflowImportServiceFolders:
    ...
    async def test_create_new_workflow_with_folder_path(
        ...
        with patch(
            "allama.workflow.store.import_service.WorkflowDefinitionsService",
