...
from allama.identifiers.common import (
    AllamaUUID,
    id_from_short,
    id_to_short,
)
...
class MockUUID(AllamaUUID[str]):
    """Test implementation of AllamaUUID."""
...
class TestAllamaUUID:
    """Test suite for AllamaUUID base class."""

    def test_missing_prefix(self) -> None:
        """Test that AllamaUUID requires a prefix."""

        class InvalidUUID(AllamaUUID):
            pass
    ...
    def test_equality(self) -> None:
        """Test that AllamaUUID instances can be compared using ==."""
    ...
    def test_equality_with_normal_uuid(self) -> None:
        """Test that AllamaUUID instances can be compared with normal UUIDs."""
...
def test_allama_uuid_serialization(test_uuid_str):
    """Test that AllamaUUID can be serialized and deserialized correctly."""
...
def test_allama_uuid_construction(test_uuid_str):
    """Test that AllamaUUID can be constructed from various inputs."""
    original_uuid = UUID(test_uuid_str)
    test_uuid = MockUUID.from_uuid(original_uuid)
