...
class TestCreateSessionActivity:
    ...
    @pytest.mark.anyio
    @patch("allama.agent.session.activities.AgentSessionService.with_session")
...
class TestRunAgentActivity:
    ...
    async def test_successful_execution(self, mock_executor_input: AgentExecutorInput):
        ...
        with (
            patch("allama.agent.executor.activity.activity") as mock_activity,
            patch(
                "allama.agent.executor.activity.SandboxedAgentExecutor"
