...
from allama.auth.credentials import get_role_from_user
from allama.auth.schemas import UserRole
from allama.auth.types import AccessLevel, OrgRole, Role
...
class TestRoleWithOrgRole:
    ...
    def test_role_to_headers_with_org_role(self):
        ...
        assert headers["x-allama-role-org-role"] == "owner"
    ...
    def test_role_to_headers_without_org_role(self):
        ...
        headers = role.to_headers()
        assert "x-allama-role-org-role" not in headers
