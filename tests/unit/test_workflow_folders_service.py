...
from allama.db.models import Workflow, Workspace
from allama.exceptions import AllamaValidationError
from allama.identifiers.workflow import WorkflowID
from allama.workflow.management.folders.schemas import WorkflowFolderCreate
...
class TestWorkflowFolderService:
    ...
    async def test_delete_folder_with_children_fails(
        ...
        with pytest.raises(AllamaValidationError):
