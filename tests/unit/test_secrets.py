...
from allama.secrets.common import apply_masks, apply_masks_object
from allama.secrets.encryption import (
    decrypt_bytes,
    decrypt_value,
    encrypt_bytes,
    encrypt_value,
...
class TestEncryption:
    ...
    def test_encrypt_decrypt_object(self, env_sandbox):
        ...
        key = os.getenv("ALLAMA__DB_ENCRYPTION_KEY")
        obj = {
...
class TestSecurityFeatures:
    ...
    def test_secret_masking_with_special_mask_value(self):
        ...
        from allama.secrets.constants import MASK_VALUE
...
class TestExecutorServiceMasking:
    ...
    def test_masking_disabled_configuration(self):
        ...
        # Simulate the ALLAMA__UNSAFE_DISABLE_SM_MASKING flag
