...
from allama.redis.client import RedisClient
...
def patch_redis(monkeypatch: pytest.MonkeyPatch) -> Generator[None, None, None]:
    ...
    monkeypatch.setattr("allama.redis.client.redis.Redis", DummyRedis)
    monkeypatch.setattr("allama.redis.client.redis.from_url", fake_from_url)
