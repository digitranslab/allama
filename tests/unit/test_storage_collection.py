...
class TestCollectionManifestSchemas:
    ...
    def test_manifest_v1_schema(self):
        ...
        from allama.storage.collection import CollectionManifestV1
        ...
        assert manifest.kind == "allama.collection_manifest"
    ...
    def test_chunk_v1_schema(self):
        ...
        from allama.storage.collection import CollectionChunkV1
        ...
        assert chunk.kind == "allama.collection_chunk"
...
class TestCollectionStorageFunctions:
    ...
    async def test_store_collection_creates_manifest_and_chunks(
        ...
        from allama.storage.collection import store_collection
    ...
    async def test_get_collection_page(self, mock_blob_storage):
        ...
        from allama.storage.collection import get_collection_page, store_collection
    ...
    async def test_get_collection_item(self, mock_blob_storage):
        ...
        from allama.storage.collection import get_collection_item, store_collection
