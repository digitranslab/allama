...
class TestSecretValidationWithEnvironmentOverride:
    ...
    async def test_action_env_pairs_generation_with_overrides(self):
        ...
        from allama.validation.service import validate_actions_have_defined_secrets
        ...
        with (
            patch(
                "allama.validation.service.get_async_session_context_manager"
            ) as mock_session_mgr,
            patch("allama.validation.service.SecretsService") as mock_secrets_service,
            patch(
                "allama.validation.service.RegistryActionsService"
            ) as mock_registry_service,
            patch("allama.validation.service.GatheringTaskGroup") as mock_task_group,
        ):
            # Setup mocks
    ...
    async def test_effective_environment_used_in_secret_validation(self):
        ...
        with (
            ...
            patch(
                "allama.validation.service.check_action_secrets_from_manifest",
