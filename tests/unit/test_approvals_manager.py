...
from allama_ee.agent.approvals.schemas import ApprovalCreate, ApprovalUpdate
...
from allama.db.models import AgentSession, User
...
class TestRecordApprovalRequestsActivity:
    ...
    async def test_record_approvals_upsert_existing(
        ...
        async with ApprovalService.with_session(role=svc_role) as service:
            ...
            from allama_ee.agent.approvals.schemas import ApprovalUpdate
