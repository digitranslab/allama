...
from allama.executor.action_runner import ActionRunner, _parse_s3_uri
...
class TestActionRunner:
    ...
    async def test_execute_action_timeout(
        ...
        with (
            patch("allama.executor.action_runner.config") as mock_config,
            patch("asyncio.create_subprocess_exec") as mock_subprocess,
        ):
            mock_config.ALLAMA__EXECUTOR_CLIENT_TIMEOUT = 0.1
            mock_config.ALLAMA__EXECUTOR_SANDBOX_ENABLED = False
            mock_config.ALLAMA__EXECUTOR_REGISTRY_CACHE_DIR = str(temp_cache_dir)
