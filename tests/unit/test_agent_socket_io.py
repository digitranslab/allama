...
from allama.agent.common.protocol import RuntimeEventEnvelope, RuntimeInitPayload
from allama.agent.common.socket_io import SocketStreamWriter, read_message
from allama.agent.common.stream_types import StreamEventType, UnifiedStreamEvent
from allama.agent.common.types import SandboxAgentConfig
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            try:
                ...
                with (
                    ...
                    patch(
                        "allama.agent.runtime.claude_code.runtime.StreamEvent",
                        MagicMock,
                    ),
                ):
                    runtime = ClaudeAgentRuntime(socket_writer)
