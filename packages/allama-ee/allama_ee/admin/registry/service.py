...
from allama.db.models import PlatformRegistryRepository, PlatformRegistryVersion
...
from allama.registry.versions.service import PlatformRegistryVersionsService
from allama.service import BasePlatformService
from allama_ee.admin.registry.schemas import (
...
from allama_ee.admin.settings.service import AdminSettingsService
    ...
    async def _sync_repository(
        ...
        try:
            if repo.origin.startswith("git+ssh://"):
                ...
                # Platform registry only supports origin=allama-registry.
                raise ValueError(
