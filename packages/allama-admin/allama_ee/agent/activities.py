...
from allama.agent.common.types import MCPServerConfig, MCPToolDefinition
...
from allama.agent.schemas import ToolFilters
from allama.agent.tokens import InternalToolContext, UserMCPServerClaim
from allama.agent.tools import build_agent_tools
...
class AgentActivities:
    ...
    async def build_tool_definitions(
        ...
        user_mcp_claims: list[UserMCPServerClaim] | None = None
        if args.mcp_servers:
            from allama.agent.mcp.user_client import discover_user_mcp_tools
