"""Authentication commands for allama-admin CLI."""
...
from allama_admin.client import AdminClient, AdminClientError
from allama_admin.config import clear_cookies, get_config, save_cookies
from allama_admin.output import print_error, print_success
    ...
    try:
        ...
        if e.response.status_code == 400:
            ...
            print_error(
                ...
                "(ALLAMA__AUTH_TYPES must include 'basic')"
            )
...
async def whoami(
    ...
    try:
        ...
        if json_output:
            ...
            from allama_admin.output import console
