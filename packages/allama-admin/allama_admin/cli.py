"""Allama Admin CLI - Main entry point."""
...
from allama_admin import __version__
from allama_admin.commands import (
    admin,
    auth,
    migrate,
    orgs,
...
app = typer.Typer(
    name="allama",
    help="Allama Admin CLI - Platform operator tools for Allama.",
...
def version_callback(value: bool) -> None:
    if value:
        typer.echo(f"allama-admin version {__version__}")
        raise typer.Exit()
...
def main(
    ...
    """Allama Admin CLI - Platform operator tools."""
