"""Configuration management for allama-admin CLI."""
...
CONFIG_PATH = Path.home() / ".allama_admin.json"
...
class Config:
    ...
    def from_env(cls) -> Config:
        ...
        return cls(
            api_url=os.environ.get("ALLAMA__API_URL", "http://localhost:8000").rstrip(
                "/"
            ),
            service_key=os.environ.get("ALLAMA__SERVICE_KEY"),
            db_uri=os.environ.get("ALLAMA__DB_URI"),
        )
