"""SDK exceptions for Allama API errors."""

from __future__ import annotations


class AllamaSDKError(Exception):
    """Base exception for all Allama SDK errors."""
...
class AllamaAPIError(AllamaSDKError):
...
class AllamaAuthError(AllamaAPIError):
...
class AllamaNotFoundError(AllamaAPIError):
...
class AllamaValidationError(AllamaAPIError):
...
class AllamaConflictError(AllamaAPIError):
