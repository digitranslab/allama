"""Workflows SDK client for Allama API."""
...
class WorkflowsClient:
    ...
    async def execute(
        ...
        *,
        ...
        Raises:
            ...
            AllamaNotFoundError: If workflow or alias not found.
            AllamaAPIError: For other API errors.
        """
    ...
    async def get_status(self, workflow_execution_id: str) -> dict[str, Any]:
        ...
        Raises:
            AllamaNotFoundError: If execution not found.
            AllamaAPIError: For other API errors.
        """
