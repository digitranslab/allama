...
from allama_registry._internal.constants import DEFAULT_NAMESPACE
from allama_registry._internal.models import RegistrySecretType
...
def register(
    *,
    ...
    This method creates a decorator that can be used to register a function as a UDF in the Allama system.
    ...
    def decorator_register(fn: Callable[P, R]) -> Callable[P, R]:
        ...
        setattr(fn, "__allama_udf", True)
        setattr(fn, "__allama_udf_key", key)
        setattr(
            fn,
            "__allama_udf_kwargs",
            {
