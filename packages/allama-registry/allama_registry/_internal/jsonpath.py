...
importing heavy allama modules during SDK-style invocation.
"""
...
from allama_registry._internal.exceptions import AllamaExpressionError
...
def eval_jsonpath(
    ...
    *,
    ...
    try:
        ...
        raise AllamaExpressionError(f"Invalid jsonpath {expr!r}") from e
