"""Configuration for allama-registry package."""
...
ALLAMA__S3_CONCURRENCY_LIMIT = int(
    os.environ.get("ALLAMA__S3_CONCURRENCY_LIMIT", 10)
)
...
class _FeatureFlags:
    """Feature flags checked directly from env to avoid heavy allama imports.

    Attributes are set in __init__ to allow patching in tests.
    """

    def __init__(self) -> None:
        _flags = os.environ.get("ALLAMA__FEATURE_FLAGS", "")
