"""Google Drive integration UDFs for Allama.
...
Uses Allama's built-in OAuth system for seamless authentication.
Configure the 'google_drive' OAuth integration in Allama UI, then users
...
from allama_registry import RegistryOAuthSecret, registry, secrets


# Use Allama's built-in OAuth system
...
Configure the 'google_drive' OAuth integration in Allama with:
...
def _get_drive_token() -> str:
    """Get access token from Allama's OAuth system."""
