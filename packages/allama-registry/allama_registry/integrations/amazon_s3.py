...
from allama_registry import RegistrySecret, registry
from allama_registry.config import (
    ALLAMA__MAX_FILE_SIZE_BYTES,
    ALLAMA__S3_CONCURRENCY_LIMIT,
)
import allama_registry.integrations.aws_boto3 as aws_boto3
...
_s3_semaphore = asyncio.Semaphore(ALLAMA__S3_CONCURRENCY_LIMIT)
...
async def put_object(
    ...
    if len(content_bytes) > ALLAMA__MAX_FILE_SIZE_BYTES:
        raise ValueError(
