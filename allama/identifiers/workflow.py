...
from allama.identifiers.common import AllamaUUID
from allama.identifiers.resource import ResourcePrefix, generate_resource_id
from allama.identifiers.schedules import SCHEDULE_EXEC_ID_PATTERN
...
class WorkflowUUID(AllamaUUID[WorkflowIDShort]):
...
class ExecutionUUID(AllamaUUID[ExecutionIDShort]):
...
class WorkspaceUUID(AllamaUUID[WorkspaceIDShort]):
