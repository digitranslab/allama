...
from allama.auth.dependencies import ExecutorWorkspaceRole
from allama.auth.schemas import UserRead
from allama.auth.users import search_users
from allama.cases.durations.schemas import CaseDurationMetric
...
from allama.cases.service import (
    CaseCommentsService,
    CasesService,
    CaseTasksService,
)
...
async def assign_user_by_email_to_case(
    *,
    ...
    Returns a simple dict representation of the updated case.
    """
    from allama.auth.users import lookup_user_by_email
