...
from allama.db.models import Case, CaseEvent, CaseTag, CaseTagLink
from allama.exceptions import AllamaNotFoundError
from allama.identifiers import CaseTagID
from allama.service import BaseWorkspaceService
from allama.tags.schemas import TagCreate, TagUpdate
...
class CaseTagsService(BaseWorkspaceService):
    ...
    async def _get_case(self, case_id: uuid.UUID) -> Case:
        ...
        if case is None:
            raise AllamaNotFoundError(f"Case {case_id} not found in this workspace.")
        return case
