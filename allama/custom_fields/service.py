...
from allama.db.locks import derive_lock_key_from_parts, pg_advisory_lock
from allama.identifiers.workflow import WorkspaceUUID
from allama.service import BaseWorkspaceService
from allama.tables.service import TableEditorService, sanitize_identifier
...
class CustomFieldsService(BaseWorkspaceService, ABC):
    ...
    async def initialize_workspace_schema(self) -> None:
        ...
        lock_key = derive_lock_key_from_parts(
            "allama.custom_fields.initialize_workspace_schema",
            self.service_name,
            self._table,
        )
