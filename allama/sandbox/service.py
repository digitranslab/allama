...
from allama.config import (
    ...
    ALLAMA__SANDBOX_DEFAULT_MEMORY_MB,
    ALLAMA__SANDBOX_DEFAULT_TIMEOUT,
    ALLAMA__SANDBOX_NSJAIL_PATH,
    ALLAMA__SANDBOX_ROOTFS_PATH,
)
from allama.logger import logger
from allama.sandbox.exceptions import (
    PackageInstallError,
    SandboxExecutionError,
)
from allama.sandbox.executor import NsjailExecutor
from allama.sandbox.safe_executor import SafePythonExecutor
from allama.sandbox.types import ResourceLimits, SandboxConfig
from allama.sandbox.wrapper import INSTALL_SCRIPT, WRAPPER_SCRIPT
...
class SandboxService:
    ...
    async def run_python(
        ...
        if timeout_seconds is None:
            timeout_seconds = ALLAMA__SANDBOX_DEFAULT_TIMEOUT
        ...
        if self._is_nsjail_available():
            ...
            logger.info(
                ...
                "For full OS-level isolation, set ALLAMA__DISABLE_NSJAIL=false "
        ...
        async with self._create_job_dir() as job_dir:
            ...
            config = SandboxConfig(
                ...
                resources=ResourceLimits(
                    timeout_seconds=timeout_seconds,
                    memory_mb=ALLAMA__SANDBOX_DEFAULT_MEMORY_MB,
                ),
