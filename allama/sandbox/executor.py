...
from allama.config import (
    ALLAMA__SANDBOX_CACHE_DIR,
    ALLAMA__SANDBOX_NSJAIL_PATH,
    ALLAMA__SANDBOX_PYPI_EXTRA_INDEX_URLS,
    ALLAMA__SANDBOX_PYPI_INDEX_URL,
    ALLAMA__SANDBOX_ROOTFS_PATH,
)
from allama.logger import logger
from allama.sandbox.exceptions import SandboxTimeoutError, SandboxValidationError
from allama.sandbox.types import ResourceLimits, SandboxConfig, SandboxResult
...
class ActionSandboxConfig:
    ...
    Attributes:
        ...
        allama_app_dir: Directory containing allama package (not mounted in untrusted mode).
...
class NsjailExecutor:
    ...
    def __init__(
        ...
        cache_dir: str = ALLAMA__SANDBOX_CACHE_DIR,
    ):
    ...
    def _build_env_map(
        ...
        if phase == "install":
            ...
            env_map["UV_INDEX_URL"] = ALLAMA__SANDBOX_PYPI_INDEX_URL
            if ALLAMA__SANDBOX_PYPI_EXTRA_INDEX_URLS:
    ...
    def _build_action_config(
        ...
        _validate_path(config.allama_app_dir, "allama_app_dir")
        ...
        # Untrusted mode uses minimal_runner.py copied to /work, no allama imports
        ...
        # minimal_runner.py is copied to /work and doesn't need allama imports
        lines.extend(
            [
                "",
                "# Execution",
    ...
    async def execute_action(
        ...
        logger.debug(
            ...
            allama_app=str(config.allama_app_dir),
        )
