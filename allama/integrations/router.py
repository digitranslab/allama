...
from allama.db.models import OAuthStateDB
from allama.integrations.dependencies import (
    ACProviderInfoDep,
    CCProviderInfoDep,
    ProviderInfoDep,
)
from allama.integrations.enums import IntegrationStatus, OAuthGrantType
from allama.integrations.providers import all_providers
...
async def oauth_callback(
    *,
    ...
    redirect_url = f"{config.ALLAMA__PUBLIC_APP_URL}/workspaces/{role.workspace_id}/integrations/{key.id}?tab=overview&grant_type=authorization_code"
