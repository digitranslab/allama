...
from allama.db.models import MCPIntegration, OAuthIntegration, WorkspaceOAuthProvider
from allama.identifiers import UserID
from allama.integrations.enums import MCPAuthType, OAuthGrantType
from allama.integrations.providers import get_provider_class
...
from allama.secrets.encryption import decrypt_value, encrypt_value, is_set
...
class IntegrationService(BaseWorkspaceService):
    ...
    def __init__(self, *args, **kwargs):
        ...
        encryption_key = (
            os.environ.get("ALLAMA__DB_ENCRYPTION_KEY")
            or config.ALLAMA__DB_ENCRYPTION_KEY
        )
