...
class WorkspaceCopilotPrompts(BaseModel):
    ...
    def instructions(self) -> str:
        ...
        return textwrap.dedent("""
            You are a helpful workspace assistant that helps users with security and IT automation operations in Allama. You can assist with workflows, cases, agents, lookup tables, and general workspace operations.
