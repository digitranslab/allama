...
from allama.identifiers import InvitationID, OrganizationID, UserID, WorkspaceID
...
class WorkspaceSettingsRead(Schema):
    ...
    def effective_allowed_attachment_extensions(self) -> list[str]:
        ...
        return sorted(config.ALLAMA__ALLOWED_ATTACHMENT_EXTENSIONS)
    ...
    def effective_allowed_attachment_mime_types(self) -> list[str]:
        ...
        return sorted(config.ALLAMA__ALLOWED_ATTACHMENT_MIME_TYPES)
