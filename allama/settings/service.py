...
from allama.common import UNSET
from allama.contexts import ctx_role, ctx_session
from allama.db.models import OrganizationSetting
from allama.identifiers import OrganizationID
from allama.logger import logger
from allama.secrets.encryption import decrypt_value, encrypt_value
from allama.service import BaseOrgService
from allama.settings.constants import SENSITIVE_SETTINGS_KEYS
from allama.settings.schemas import (
    AgentSettingsUpdate,
    AppSettingsUpdate,
...
async def get_setting(
    ...
    *,
    ...
    if role is not None and role.organization_id is None:
        from allama.api.common import get_default_organization_id
        from allama.auth.types import Role as RoleClass
...
def get_setting_override(key: str) -> Any | None:
    ...
    return os.environ.get(f"ALLAMA__SETTING_OVERRIDE_{key.upper()}")
