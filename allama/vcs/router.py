...
from allama.auth.dependencies import OrgAdminUser
...
from allama.vcs.github.flows import handle_manifest_conversion
from allama.vcs.github.manifest import generate_github_app_manifest
from allama.vcs.schemas import (
    ...
    try:
        ...
        return GitHubAppManifestResponse(
            ...
            instructions=[
                ...
                "6. GitHub will redirect back to Allama to complete the setup automatically",
            ],
        )
