...
def generate_github_app_manifest() -> GitHubAppManifest:
    ...
    public_app_url = config.ALLAMA__PUBLIC_APP_URL.rstrip("/")
    public_api_url = config.ALLAMA__PUBLIC_API_URL.rstrip("/")
    ...
    return GitHubAppManifest(
        ...
        description="GitHub App for Allama to manage workflow synchronization with Git repositories. This app enables automated pull request creation for workflow changes.",
        public=False,
        default_permissions={
            "contents": "write",
            "metadata": "read",
