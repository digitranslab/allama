...
from allama.auth.types import AccessLevel
from allama.authz.controls import require_access_level
from allama.exceptions import AllamaException
from allama.git.types import GitUrl
...
from allama.vcs.github.schemas import (
    GitHubAppConfig,
    GitHubAppCredentials,
)


class GitHubAppError(AllamaException):
...
class GitHubAppService(BaseOrgService):
    ...
    async def register_existing_app(
        ...
        """Register existing GitHub App credentials that were created outside of Allama.

        Use this method when you have an existing GitHub App that was created manually
        in GitHub's settings, and you want to store its credentials in Allama.
