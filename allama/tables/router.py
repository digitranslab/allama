...
from allama.exceptions import AllamaImportError, AllamaNotFoundError
...
from allama.tables.importer import CSVImporter
...
async def import_table_from_csv(
    ...
    try:
        contents = await _read_csv_upload_with_limit(
            file, max_size=config.ALLAMA__MAX_TABLE_IMPORT_SIZE_BYTES
        )
