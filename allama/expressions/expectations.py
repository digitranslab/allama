...
from allama.registry.fields import get_components_for_union_type, type_drop_null
...
def create_expectation_model(
    ...
    for field_name, field_info in schema.items():
        ...
        # Handle Allama component annotations
        ...
        if components:
            ...
            jsonschema_extra["x-allama-component"] = to_jsonable_python(components)
