...
from allama.auth.types import PlatformRole, Role
from allama.contexts import ctx_role
from allama.registry.actions.schemas import RegistryActionCreate
from allama.registry.constants import (
    DEFAULT_LOCAL_REGISTRY_ORIGIN,
    DEFAULT_REGISTRY_ORIGIN,
)
from allama.registry.sync.schemas import RegistrySyncRequest
from allama.registry.sync.subprocess import fetch_actions_from_subprocess
from allama.registry.sync.tarball import (
    TarballBuildError,
...
from allama.service import BaseService
from allama.storage import blob

if TYPE_CHECKING:
    from collections.abc import Sequence

    from allama.ssh import SshEnv
...
class BaseRegistrySyncService[
    ...
    async def sync_repository_v2(
        ...
        *,
        ...
        use_temporal = (
            config.ALLAMA__REGISTRY_SYNC_SANDBOX_ENABLED and not bypass_temporal
        )
        ...
        self.logger.info(
            ...
            sandbox_enabled=config.ALLAMA__REGISTRY_SYNC_SANDBOX_ENABLED,
        ...
        *,
        ...
        async with aiofiles.tempfile.TemporaryDirectory(
            ...
            if origin == DEFAULT_REGISTRY_ORIGIN:
                ...
                local_path = Path(config.ALLAMA__LOCAL_REPOSITORY_CONTAINER_PATH)
            ...
            bucket = config.ALLAMA__BLOB_STORAGE_BUCKET_REGISTRY
    ...
    def _generate_version_string(
        ...
        if origin == DEFAULT_REGISTRY_ORIGIN:
            ...
            return allama_registry.__version__
    ...
    async def _sync_via_temporal_workflow(
        ...
        *,
        ...
        from allama.registry.sync.workflow import RegistrySyncWorkflow
