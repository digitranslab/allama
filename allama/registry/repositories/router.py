...
from allama.registry.common import reload_registry
from allama.registry.constants import DEFAULT_REGISTRY_ORIGIN, REGISTRY_REPOS_PATH
from allama.registry.repositories.platform_service import PlatformRegistryReposService
from allama.registry.repositories.schemas import (
    GitCommitInfo,
...
from allama.registry.versions.service import (
    PlatformRegistryVersionsService,
    RegistryVersionsService,
)
from allama.settings.service import get_setting
from allama.ssh import ssh_context
from allama.tiers.entitlements import Entitlement, check_entitlement
...
async def sync_registry_repository(
    *,
    ...
    except AllamaCredentialsNotFoundError as e:
...
async def _sync_platform_repository(
    *,
    ...
    Platform registries (like the base allama-registry) are shared across all
...
async def list_registry_repositories(
    *,
    ...
    using UNION ALL. Platform repositories (like allama-registry) are shared across
    all organizations.
