...
Supported backends (via ALLAMA__EXECUTOR_BACKEND):
...
async def main() -> None:
    ...
    max_concurrent = int(
        os.environ.get("ALLAMA__EXECUTOR_MAX_CONCURRENT_ACTIVITIES", 100)
    )
    threadpool_max_workers = int(
        os.environ.get("ALLAMA__EXECUTOR_THREADPOOL_MAX_WORKERS", 100)
    )
    ...
    logger.info(
        ...
        executor_backend=config.ALLAMA__EXECUTOR_BACKEND,
    )
