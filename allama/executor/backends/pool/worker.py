...
- ALLAMA_WORKER_ID: Worker ID (0, 1, 2, ...)
- ALLAMA_WORKER_SOCKET: Path to Unix socket
- ALLAMA__POOL_WORKER_TEST_MODE: If "true", return mock success without executing actions
"""
...
# =============================================================================
from allama import config  # noqa: E402
from allama.auth.types import Role  # noqa: E402
from allama.contexts import ctx_role  # noqa: E402
from allama.executor.minimal_runner import run_action_minimal_async  # noqa: E402
from allama.executor.schemas import (  # noqa: E402
    ExecutorActionErrorInfo,
    ResolvedContext,
)
from allama.logger import logger  # noqa: E402
...
def _ensure_tarball_paths_in_sys_path() -> None:
    ...
    """
    cache_dir = Path(config.ALLAMA__EXECUTOR_REGISTRY_CACHE_DIR)
...
_worker_id = int(os.environ.get("ALLAMA_WORKER_ID", "0"))
_test_mode = os.environ.get("ALLAMA__POOL_WORKER_TEST_MODE", "").lower() == "true"
...
async def handle_connection(
    ...
    task_timeout = float(os.environ.get("ALLAMA__POOL_WORKER_TASK_TIMEOUT", "300"))
    action_name = "unknown"
    task_ref = "unknown"
...
def main() -> None:
    """Worker entrypoint."""
    worker_id = int(os.environ.get("ALLAMA_WORKER_ID", "0"))
    socket_path = Path(
        os.environ.get(
            "ALLAMA_WORKER_SOCKET", f"/tmp/allama-workers/worker-{worker_id}.sock"
        )
    )
