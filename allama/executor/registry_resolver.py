...
from allama.executor.schemas import ActionImplementation
from allama.identifiers import OrganizationID
from allama.logger import logger
from allama.registry.actions.schemas import RegistryActionImplValidator
...
async def _fetch_manifest(
    ...
    Routes to platform tables for the base registry (allama-registry),
