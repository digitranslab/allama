...
with workflow.unsafe.imports_passed_through():
    ...
    from allama.dsl.action import DSLActivities
    ...
    from allama.dsl.validation import resolve_time_anchor_activity
    from allama.dsl.workflow import DSLWorkflow
    from allama.ee.interactions.service import InteractionService
    from allama.logger import logger
    from allama.storage.collection import CollectionActivities
...
def new_sandbox_runner() -> SandboxedWorkflowRunner:
    ...
    # Pass through allama modules to avoid class identity mismatches
...
async def main() -> None:
    ...
    from allama.logger import _logger
    ...
    with ThreadPoolExecutor(max_workers=threadpool_max_workers) as executor:
        ...
        async with Worker(
            client,
            task_queue=os.environ.get("TEMPORAL__CLUSTER_QUEUE", "allama-task-queue"),
