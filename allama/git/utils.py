...
from allama.exceptions import AllamaSettingsError
from allama.git.constants import GIT_SSH_URL_REGEX
...
async def prepare_git_url(
    ...
    allowed_domains_setting = await get_setting_cached(
        ...
        # Must be hashable
        default=frozenset(config.ALLAMA__ALLOWED_GIT_DOMAINS),
    )
    ...
    try:
        ...
        raise AllamaSettingsError(str(e)) from e
    return git_url
