...
from allama.agent.mcp.proxy_server import create_proxy_mcp_server
from allama.agent.mcp.utils import normalize_mcp_tool_name
from allama.agent.runtime.claude_code.adapter import ClaudeSDKAdapter
...
class ClaudeAgentRuntime:
    ...
    def _build_system_prompt(
        ...
        base = "If asked about your identity, you are a Allama automation assistant."
    ...
    async def run(self, payload: RuntimeInitPayload) -> None:
        ...
        try:
            ...
            if self.registry_tools:
                ...
                mcp_servers["allama-registry"] = proxy_config
