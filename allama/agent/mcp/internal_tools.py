...
from allama.agent.preset.schemas import AgentPresetRead, AgentPresetUpdate
from allama.agent.session.schemas import (
    AgentSessionRead,
    AgentSessionReadWithMessages,
)
from allama.agent.tokens import InternalToolContext, MCPTokenClaims
...
async def update_preset(args: dict[str, Any], claims: MCPTokenClaims) -> dict[str, Any]:
    ...
    async with AgentPresetService.with_session(role=role) as service:
        ...
        except AllamaValidationError as error:
