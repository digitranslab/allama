"""Trusted MCP server for Allama agent.
...
Run with uvicorn on a Unix socket:
    uvicorn allama.agent.mcp.trusted_server:app --uds /var/run/allama/mcp.sock
...
async def execute_action_tool(
    ...
    """Execute any Allama registry action.
