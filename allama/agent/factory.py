...
from allama.agent.parsers import parse_output_type
from allama.agent.prompts import ToolCallPrompt, VerbosityPrompt
from allama.agent.providers import get_model
from allama.agent.runtime.pydantic_ai.adapter import to_pydantic_ai_tools
...
async def build_agent(config: AgentConfig) -> Agent[Any, Any]:
    ...
    if config.actions:
        ...
        # Convert Allama Tools to pydantic-ai Tools
