...
Usage:
    python -m allama.agent.sandbox.entrypoint
"""
...
from allama.agent.common.config import JAILED_CONTROL_SOCKET_PATH
...
from allama.agent.sandbox.llm_bridge import LLMBridge
from allama.logger import logger

if TYPE_CHECKING:
    from allama.agent.runtime.base import BaseRuntime

# Registry of available runtimes (lazy imports for cold start optimization)
RUNTIME_REGISTRY: dict[str, str] = {
    "claude_code": "allama.agent.runtime.claude_code.runtime.ClaudeAgentRuntime",
}
