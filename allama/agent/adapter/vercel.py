...
from allama.agent.stream.events import (
    StreamDelta,
    StreamEnd,
    StreamError,
    StreamEvent,
...
from allama.agent.types import UnifiedMessage
from allama.chat.constants import (
        ...
        for part_type, part in _iter_message_parts(message_data):
            ...
            match part_type:
                ...
                case "ToolUseBlock":
                    ...
                    if (
                        part.name == "mcp__allama-registry__execute_tool"
