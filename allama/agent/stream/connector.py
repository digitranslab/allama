...
from allama.agent.common.stream_types import UnifiedStreamEvent
...
from allama.agent.types import ModelMessageTA, StreamKey
from allama.chat import tokens
from allama.logger import logger
from allama.redis.client import RedisClient, get_redis_client
...
class AgentStream:
    ...
    def sse(
        ...
        match format:
            case "vercel":
                from allama.agent.adapter.vercel import sse_vercel
