...
from allama.config import ALLAMA__AGENT_MAX_RETRIES

if TYPE_CHECKING:
    from pydantic_ai.messages import ModelMessage
    from pydantic_ai.tools import Tool as _PATool

    from allama.agent.stream.writers import StreamWriter
...
class MCPServerConfig(TypedDict):
    ...
    """Optional: Auth headers (can reference Allama secrets)."""
...
# These types decouple Allama from pydantic-ai's internal types,
