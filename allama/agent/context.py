...
from allama.config import (
    ALLAMA__AGENT_DEFAULT_CONTEXT_LIMIT,
    ALLAMA__AGENT_TOOL_OUTPUT_LIMIT,
...
def truncate_tool_returns_processor(
    ...
    Uses ALLAMA__AGENT_TOOL_OUTPUT_LIMIT from config (default 80k chars).
    """
    max_chars = ALLAMA__AGENT_TOOL_OUTPUT_LIMIT
...
def trim_history_processor(
    ...
    token_budget = ALLAMA__MODEL_CONTEXT_LIMITS.get(
        ctx.model.model_name, ALLAMA__AGENT_DEFAULT_CONTEXT_LIMIT
    )
