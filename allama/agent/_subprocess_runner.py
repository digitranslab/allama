...
from allama.expressions.eval import collect_expressions, eval_templated_object
...
async def run_action(
    ...
    Uses the same implementation as the original call_allama_action from main,
