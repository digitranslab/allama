...
from allama.db.models import Schedule
from allama.db.session_events import add_after_commit_callback
from allama.exceptions import AllamaNotFoundError
from allama.identifiers import ScheduleUUID, WorkflowID
from allama.identifiers.schedules import AnyScheduleID
...
from allama.storage.object import InlineObject
from allama.workflow.schedules import bridge
from allama.workflow.schedules.schemas import (
...
class WorkflowSchedulesService(BaseWorkspaceService):
    ...
    async def create_schedule(
        ...
        role_copy = self.role.model_copy(
            update={
                "type": "service",
                "service_id": "allama-schedule-runner",
    ...
    async def get_schedule(self, schedule_id: AnyScheduleID) -> Schedule:
        ...
        try:
            ...
            raise AllamaNotFoundError(f"Schedule {schedule_uuid} not found") from e
