...
from allama.exceptions import AllamaNotFoundError, AllamaServiceError
...
from allama.workflow.schedules.dependencies import AnyScheduleIDPath
...
async def create_schedule(
    ...
    except AllamaServiceError as e:
