...
from allama.dsl.common import DSLRunArgs
...
from allama.workflow.executions.enums import TemporalSearchAttr, TriggerType
from allama.workflow.schedules.schemas import ScheduleUpdate
...
async def update_schedule(schedule_id: AnyScheduleID, params: ScheduleUpdate) -> None:
    async def _update_schedule(
        ...
        if isinstance(action, temporalio.client.ScheduleActionStartWorkflow):
            ...
            from allama.workflow.executions.common import extract_first
            ...
            try:
                ...
                role = Role(type="service", service_id="allama-schedule-runner")
