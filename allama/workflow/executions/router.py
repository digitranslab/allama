...
from allama.agent.schemas import AgentOutput
from allama.agent.types import ClaudeSDKMessageTA
from allama.auth.dependencies import WorkspaceUserRole
from allama.auth.enums import SpecialUserID
from allama.db.dependencies import AsyncDBSession
from allama.db.models import WorkflowDefinition
from allama.dsl.common import (
    DSLInput,
    get_execution_type_from_search_attr,
    get_trigger_type_from_search_attr,
)
from allama.ee.interactions.schemas import InteractionRead
...
from allama.identifiers.workflow import OptionalAnyWorkflowIDQuery, WorkflowUUID
...
from allama.workflow.executions.dependencies import UnquotedExecutionID
            ...
            try:
                ...
                if output.message_history:
                    ...
                    event.session.events = (
                        allama.agent.adapter.vercel.convert_chat_messages_to_ui(
