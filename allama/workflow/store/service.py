...
from allama.exceptions import AllamaSettingsError, AllamaValidationError
...
from allama.sync import Author, PushObject, PushOptions
...
class WorkflowStoreService(BaseWorkspaceService):
    ...
    async def publish_workflow_dsl(
        ...
        *,
        ...
        author = Author(name="Allama", email="noreply@allama.com")
