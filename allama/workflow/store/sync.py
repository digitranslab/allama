"""Workflow synchronization functionality for Allama."""
...
from allama.git.utils import GitUrl
...
from allama.vcs.github.app import GitHubAppError, GitHubAppService
from allama.workflow.store.import_service import WorkflowImportService
from allama.workflow.store.schemas import RemoteWorkflowDefinition
    ...
    async def push(
        ...
        *,
        ...
        try:
            ...
            branch_name = f"allama-sync-{timestamp}"
            ...
            if options.create_pr:
                try:
                    ...
                    if not workspace:
                        raise AllamaNotFoundError("Workspace not found")
                    ...
                    pr = await asyncio.to_thread(
                        ...
                        body=(
                            f"Automated workflow sync from Allama\n\n"
