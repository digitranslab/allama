...
# EKS Module - Cluster, Node Groups, Add-ons, Data Services, Allama Helm Release
module "eks" {
  source = "./modules/eks"
  ...
  domain_name        = var.domain_name
  hosted_zone_id     = var.hosted_zone_id
  allama_version   = var.allama_version
  allama_image_tag = var.allama_image_tag
  superadmin_email   = var.superadmin_email

  # Allama Secrets (AWS Secrets Manager ARN)
  allama_secrets_arn = var.allama_secrets_arn
