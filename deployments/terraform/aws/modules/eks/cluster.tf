...
# EKS Cluster
resource "aws_eks_cluster" "allama" {
...
resource "aws_eks_addon" "vpc_cni" {
  cluster_name = aws_eks_cluster.allama.name
  addon_name   = "vpc-cni"
...
resource "aws_eks_node_group" "allama" {
  cluster_name    = aws_eks_cluster.allama.name
...
data "aws_eks_cluster_auth" "allama" {
  name = aws_eks_cluster.allama.name
}
