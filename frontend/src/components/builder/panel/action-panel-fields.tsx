...
import {
  ...
  getAllamaComponents,
  type AllamaComponentId,
  type AllamaEditorComponent,
  type AllamaJsonSchema,
} from "@/lib/schema"
...
export function PolymorphicField({
  ...
  const components = getAllamaComponents(fieldDefn)
    ...
    fieldTypes = [
      ...components
        .filter(
          (
            component
          ): component is AllamaEditorComponent & {
            component_id: AllamaComponentId
  ...
  const allComponents: AllamaEditorComponent[] = [
    ...components,
    { component_id: "expression" } as ExpressionComponent,
  ]

  // Handle field type changes
  const handleFieldTypeChange = (newFieldType: AllamaComponentId) => {
...
function ComponentContent({
  ...
  component: AllamaEditorComponent
...
const COMPONENT_LABELS: Record<AllamaComponentId, string> = {
  text: "Text",
  "text-area": "Text Area",
  select: "Select",
  "tag-input": "Tags",
...
const COMPONENT_ICONS: Record<AllamaComponentId, LucideIcon> = {
  text: TypeIcon,
  "text-area": TypeIcon,
  select: ListIcon,
  "tag-input": ListIcon,
