...
import type { AllamaJsonSchema } from "@/lib/schema"
...
const getPrimaryType = (schema: AllamaJsonSchema): string | undefined => {
  if (!schema.type) {
    return undefined
  }
  ...
  const properties = useMemo(
    () =>
      Object.entries(schema.properties ?? {}).filter(
        (entry): entry is [string, AllamaJsonSchema] =>
