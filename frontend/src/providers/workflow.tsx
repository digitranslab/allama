...
import type { AllamaApiError } from "@/lib/errors"
...
export function WorkflowProvider({
  ...
  const { mutateAsync: commitWorkflow } = useMutation({
    ...
    onError: (error: ApiError) => {
      ...
      toast({
        ...
        description:
          (error.body as AllamaErrorMessage).message ||
  ...
  const { mutateAsync: publishWorkflow } = useMutation({
    ...
    onError: (error: ApiError) => {
      ...
      const apiError = error as AllamaApiError<string>
