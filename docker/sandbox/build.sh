...
#   ROOTFS_PATH: Optional path to extract rootfs to (default: /var/lib/allama/sandbox-rootfs)

set -euo pipefail

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
ROOTFS_PATH="${1:-/var/lib/allama/sandbox-rootfs}"
IMAGE_NAME="allama-sandbox-rootfs:latest"
